...
typedef struct {
    ...
    mpz_t lambda1; /*lambda shares for shared decryption*/
    mpz_t lambda2;
} djn_prvkey_t;
...
//shared decryption function for two-server setting
...
//scalar multiplication under homomorphic encryption
void djn_hm_scalarmult(djn_pubkey_t* pub, mpz_t res, mpz_t ct, mpz_t exp);

//addition under homomorphic encryption
